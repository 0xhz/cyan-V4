...
module.exports = {
  name: "mass_cupons",
  description: "Crie vários cupons",
  ...
  run: async (client, interaction, message) => {
    ...
    if (discount > 100) return interaction.reply({ content: '<:sino:1237422653132902463> O desconto não pode ser maior que 100%', ephemeral: true })
    if (discount < 0) return interaction.reply({ content: '<:sino:1237422653132902463> O desconto não pode ser menor que 0%', ephemeral: true })
    if (days < 0) return interaction.reply({ content: '<:sino:1237422653132902463> Os dias não podem ser menor que 0', ephemeral: true })
    if (max_uses < 0) return interaction.reply({ content: '<:sino:1237422653132902463> O máximo de usos não pode ser menor que 0', ephemeral: true })
    if (amount < 0) return interaction.reply({ content: '<:sino:1237422653132902463> A quantidade não pode ser menor que 0', ephemeral: true })
    if (buy_amount_max < 0) return interaction.reply({ content: '<:sino:1237422653132902463> A quantidade de compra máxima não pode ser menor que 0', ephemeral: true })
    if (buy_amount < 0) return interaction.reply({ content: '<:sino:1237422653132902463> A quantidade de compra não pode ser menor que 0', ephemeral: true })
    ...
    interaction.reply({
      content: `<:accept:1237422643544854549> O **cupom** foi criado com sucesso em ${clientesComCupom.length} produtos e __possivelmente__ falhou nos produtos abaixo:\n\n\`${clientesSemCupom.slice(0, 10).join('\n')}${clientesSemCupom.length > 10 ? `\n... e mais ${clientesSemCupom.length - 10} produtos` : ''}\``,
      ephemeral: true
    });
