        ...
        if (method === 'pix') {
            ...
            if (res?.data.status == 'approved' || payment.data.pagamentos.id == `Aprovado Manualmente`) { //pending // approved
                ...
                const mandanopvdocara = new EmbedBuilder()
                    ...
                    .setTitle(`<a:1236149701401907210:1237422699740135535> Aguarde...`)
                    .setFooter(
                ...
                if (configuracao.get('pagamentos.BancosBloqueados') !== null) {
                    ...
                    const embed = new EmbedBuilder()
                        ...
                        .setDescription(`<:reembolso:1237422662729597059> Esse servidor não está aceitando pagamentos desta instituição \`${bank}\`, seu dinheiro foi reembolsado, tente novamente usando outro banco.`)
                        .addFields(
                    ...
                    const embed2 = new EmbedBuilder()
                        ...
                        .setDescription(`<:reembolso:1237422662729597059> Esse servidor não está aceitando pagamentos desta instituição \`${bank}\`, o dinheiro do Comprador foi reembolsado, Obrigado por confiar em meu trabalho.`).addFields(
                            { name: `Detalhes`, value: `\`${yy.quantidadeselecionada}x ${yy.infos.produto} - ${yy.infos.campo} | R$ ${Number(valor).toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}\`` }
                        )
                ...
                await msg.edit({ content: `<a:1236149701401907210:1237422699740135535> Aguarde...`, embeds: [] })
                ...
                const mandanopvdocara2 = new EmbedBuilder()
                    ...
                    .setAuthor({ name: `${yy.user.globalName}` })
                    .setTitle(`<:aprovado:1237422659319496795> Pagamento confirmado`)
                    .setDescription('<a:1236149701401907210:1237422699740135535> Aguarde...')
                    .setFooter(
                        { text: yy.guild.name, iconURL: yy.guild.iconURL }
                    )
                    .setTimestamp()
                ...
                const dsfjmsdfjnsdfj2 = new EmbedBuilder()
                    ...
                    .setTitle(`<:aprovado:1237422659319496795> Pedido aprovado`)
                ...
                //threadChannel.setName(`<a:1236149701401907210:1237422699740135535>・${yy.user.username}・${yy.user.id}`);
