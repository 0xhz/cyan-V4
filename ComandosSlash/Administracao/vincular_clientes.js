...
module.exports = {
  ...
  run: async (client, interaction, message) => {
    ...
    interaction.editReply({ ephemeral: true, content: `<:accept:1237422643544854549> | Processo de sincronização de clientes concluído. ${clientesSetadosComSucesso} usuários foram sincronizados com sucesso.` });
