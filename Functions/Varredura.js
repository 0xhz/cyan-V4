...
async function Varredura(client) {
    ...
    const embed3 = new EmbedBuilder()
        ...
        .setDescription(`O bot da Hopius está realizando uma varredura nos pagamentos para verificar a existência de quaisquer reembolsos suspeitos.`)
        .setFooter({ iconURL: `https://media.discordapp.net/attachments/1237227861069398059/1237548995274870804/03-19-26-213_512.gif?ex=663c0cd1&is=663abb51&hm=27cc1f7dee424325f8caa904683495daa8033d49cca4df2f083782f7b79b601f&=&width=384&height=384`, text: `Sistema Anti-Fraude - Hopius.` })
        .setTimestamp();
