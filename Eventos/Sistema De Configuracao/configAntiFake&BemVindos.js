            ...
            if (interaction.customId === 'joaozinhoAntiFake') {
                ...
                if (title !== 'não') {
                    if (!isNaN(title)) {
                        ...
                        interaction.reply({ content: `<:cancel:1237422533838635028> | Você colocou um numero incorreto nos dias!`, ephemeral: true })
                        return
                    }
                } else {
                ...
                interaction.reply({ content: `<:accept:1237422643544854549> | Todas configurações de Anti-Fake foram configuradas com sucesso!`, ephemeral: true })
