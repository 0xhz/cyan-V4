...
async function CreateCarrinho(interaction, infos) {
    await interaction.reply({ content: `<a:1236149701401907210:1237422699740135535> Aguarde...`, ephemeral: true }).then(async msg => {
        ...
        if (thread2222 !== undefined) {
            ...
            interaction.editReply({ content: `<:cancel:1237422533838635028> Você já possuí um carrinho aberto.`, components: [row4] })
            return
        }
        ...
        msg.edit({ content: `<:accept:1237422643544854549> Carrinho criado!`, components: [row4] })
