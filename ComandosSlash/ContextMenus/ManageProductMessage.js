...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    if (msg.type == 2) {
      ...
      if (produto == undefined) return interaction.reply({ content: `<:cancel:1237422533838635028> | Produto não encontrado.`, ephemeral: true })
      const aa = produtos.get(produto)
      if (aa == null) return interaction.reply({ content: `<:cancel:1237422533838635028> | Produto não encontrado.`, ephemeral: true })
