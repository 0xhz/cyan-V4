    ...
    run: async (interaction, client) => {
        ...
        if (interaction.isButton()) {
                    ...
                    if (status === false) {
                            ...
                            if (geral.message == 'Usuario nao encontado!') {
                                ...
                                if (existia === 'Não definido' || existia !== geral.access_token) {
                                    ...
                                    interaction.editReply({
                                        content: `**Status:** <:accept:1237422643544854549> Autorização bem sucedida!.`,
                        ...
                        setTimeout(() => {
                            ...
                            interaction.editReply({
                                embeds: [
                                    new EmbedBuilder()
                                        .setDescription('<:cancel:1237422533838635028> | Você não autorizou durante 5 Minutos, tente novamente!')
                                ],
                                components: [fernandinhaa]
                            })
            ...
            if (interaction.customId == 'configurarmercadopago') {
                ...
                interaction.update({ embeds: [], components: [fernandona], content: `Oque deseja configurar?` })
...
let arrayDeBancos
                ...
                if (title2 !== '') {
                    if (isNaN(title2) == true) return interaction.reply({ content: `<:cancel:1237422533838635028> | Você colocou um tempo incorreto para a mensagem ser apagada!`, ephemeral: true })
                } else {
                    title2 = 0
                }
