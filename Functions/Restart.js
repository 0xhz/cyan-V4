...
async function restart(client, status) {
    const embed = new EmbedBuilder()
        ...
        .setFooter({ text: `Atenciosamente, Equipe Hopius - Updates`, iconURL: `https://media.discordapp.net/attachments/1237547289589846061/1237547430560530462/6555d1b6-7404-427b-8434-22e931707c90.png?ex=663c0b5b&is=663ab9db&hm=689262753d2f19d6b91c9b2d4624071eca4e787129cc6d5b574f693f4164b88f&=&format=webp&quality=lossless&width=312&height=312` })
        .setTimestamp()

    const row222 = new ActionRowBuilder()
        .addComponents(
            new ButtonBuilder()
                .setURL('https://discord.com/channels/1237547289589846057/1237547767618994237')
