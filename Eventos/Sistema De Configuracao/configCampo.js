        ...
        if (interaction.type == Discord.InteractionType.ModalSubmit) {
            if (interaction.customId === 'sdaju11111idsjjs123dua123') {
                ...
                if (a1 !== '') {
                    if (regexPadrao.test(a1)) {
                        ...
                        return interaction.reply({ ephemeral: true, content: `<:cancel:1237422533838635028> Cor \`${a1}\` inválida (Principal).` })
                    }
                }
                if (a2 !== '') {
                    if (regexPadrao.test(a2)) {
                        ...
                        return interaction.reply({ ephemeral: true, content: `<:cancel:1237422533838635028> Cor \`${a2}\` inválida (Processamento).` })
                    }
                }
                if (a3 !== '') {
                    if (regexPadrao.test(a3)) {
                        ...
                        return interaction.reply({ ephemeral: true, content: `<:cancel:1237422533838635028> Cor \`${a3}\` inválida (Sucesso).` })
                    }
                }
                if (a4 !== '') {
                    if (regexPadrao.test(a4)) {
                        ...
                        return interaction.reply({ ephemeral: true, content: `<:cancel:1237422533838635028> Cor \`${a4}\` inválida (Falha).` })
                    }
                }
                if (a5 !== '') {
                    if (regexPadrao.test(a5)) {
                        ...
                        return interaction.reply({ ephemeral: true, content: `<:cancel:1237422533838635028> Cor \`${a5}\` inválida (Finalizado).` })
                    }
                }

                interaction.reply({ content: `<:accept:1237422643544854549> | Cores atualizadas com sucesso!`, ephemeral: true })
            ...
            if (interaction.customId === 'sdaju11111231idsjjs123dua123') {
                ...
                if (a1 !== '') {
                    try {
                        ...
                        return interaction.reply({ ephemeral: true, content: `<:cancel:1237422533838635028> Nome inserido \`${a1}\` inválido ou então você alterou mais de 3 vezes o nome em 1 hora!` })
                    }
                }
                if (a2 !== '') {
                    try {
                        ...
                        return interaction.reply({ ephemeral: true, content: `<:cancel:1237422533838635028> Avatar inserido \`${a2}\` inválido.` })
                    }
                }
                ...
                await interaction.reply({ content: `<:accept:1237422643544854549> | Configurações atualizadas com sucesso!`, ephemeral: true })
            ...
            if (interaction.customId === 'dassdadassddsdasddassddasd') {
                ...
                if (ADD !== '') {
                    ...
                    if (ddd == null) return interaction.reply({ ephemeral: true, content: `<:cancel:1237422533838635028> Cargo inserido \`${ADD}\` inválido.` })
                ...
                if (REM !== '') {
                    ...
                    if (ddd == null) return interaction.reply({ ephemeral: true, content: `<:cancel:1237422533838635028> Cargo inserido \`${REM}\` inválido.` })
                ...
                interaction.followUp({ content: `<:accept:1237422643544854549> | Alterações realizadas com sucesso!`, ephemeral: true })
            ...
            if (interaction.customId === 'configcampoo') {
                ...
                if (isNaN(preco)) return interaction.reply({ ephemeral: true, content: `<:cancel:1237422533838635028> Preço inserido \`${preco}\` inválido.` })
                ...
                if (ggg.camposelect !== nomecampo) {
                    ...
                    if (produtoExistente) return interaction.reply({ ephemeral: true, content: `<:cancel:1237422533838635028> Nome do campo já existente.` })
                }
            ...
            if (interaction.customId == 'definircondicoes') {
                ...
                if (idcargo !== '') {
                    ...
                    if (ddd == null) return interaction.reply({ ephemeral: true, content: `<:cancel:1237422533838635028> Cargo inserido \`${idcargo}\` inválido.` })
                }

                if (valorminimo !== '') {
                    valorminimo = parseInt(valorminimo, 10);
                    if (!Number.isInteger(valorminimo)) {
                        return interaction.reply({ ephemeral: true, content: `<:cancel:1237422533838635028> Quantidade inserida \`${valorminimo}\` inválido. Insira apenas números inteiros.` });
                    }
                }
                ...
                if (valormaximo !== '') {
                    ...
                    if (!Number.isInteger(valormaximo)) {
                        return interaction.reply({ ephemeral: true, content: `<:cancel:1237422533838635028> Quantidade inserida \`${valormaximo}\` inválido. Insira apenas números inteiros.` });
                    }
                }
...
**Deseja adicionar o valor de \`${qtdlinhas}\`\ itens ao estoque de \`${ggg22.campo}\`?**
            ...
            if (interaction.customId == 'sd1213aju11111idsjjsdua') {
                ...
                if (qtd > 100000) return interaction.reply({ content: `<:cancel:1237422533838635028> Não foi possível adicionar esse estoque.`, ephemeral: true })

                if (isNaN(qtd)) return interaction.reply({ content: `<:cancel:1237422533838635028> Esse número não é válido \`${qtd}\`.`, ephemeral: true })
                ...
                await interaction.reply({ content: `<a:1236149701401907210:1237422699740135535> Aguarde...`, ephemeral: true }).then(async tt => {

                    await tt.edit({ content: `<a:1236149701401907210:1237422699740135535> Atualizando estoque...` }).then(async msg => {
                    ...
                    await tt.edit({ content: `<a:1236149701401907210:1237422699740135535> Sincronizando mensagens...`, ephemeral: true }).then(async msg => {
                        await UpdateMessageProduto(client, ggg.name)

                    })

                    await tt.edit({ content: `<:accept:1237422643544854549> Total de \`${qtd}\` itens fantasma adicionado ao estoque.`, ephemeral: true })
                })
            ...
            if (interaction.customId == 'sdaju11124124111231idsjjs123dua123') {
                ...
                if (qtd !== 'sim') return interaction.reply({ content: `<:cancel:1237422533838635028> Confirmação não validada.`, ephemeral: true });
                ...
                try {
                    const syncMessage = await interaction.followUp({ content: `<a:1236149701401907210:1237422699740135535> Sincronizando mensagens...`, ephemeral: true, fetchReply: true });
                    await UpdateMessageProduto(client, ggg.name);

                    interaction.editReply({ message: syncMessage, content: `<:accept:1237422643544854549> Processo concluído!` })
        ...
        if (interaction.isButton()) {
                ...
                interaction.reply({ ephemeral: true, content: `❓ Envie um ou mais arquivo de texto contendo o estoque que deseja adicionar, expira <t:${Math.ceil(timeStamp / 1000)}:R>.` }).then(msgggg => {
                    ...
                    collector.on('collect', async (message) => {
                        ...
                        if (message.attachments.size !== 0) {
                            ...
                            await interaction.editReply({ embeds: [], components: [], content: '<a:1236149701401907210:1237422699740135535> Aguarde...' })
            ...
            if (interaction.customId == 'simestoque') {
                await interaction.update({ content: `<a:1236149701401907210:1237422699740135535> Aguarde...`, components: [] })
                let estoque
                ...
                await interaction.editReply({ content: `<a:1236149701401907210:1237422699740135535> Atualizando estoque...`, components: [] }).then(async msg => {


                })

                await interaction.editReply({ content: `<a:1236149701401907210:1237422699740135535> Sincronizando mensagens...`, ephemeral: true })
                ...
                await interaction.editReply({
                    components: [row3], content: `<:accept:1237422643544854549> Estoque de ${ggg.campo} atualizado.`
                })
            ...
            if (interaction.customId.startsWith('avisarestoqueeeee')) {
                ...
                if (yy == 0 || yy == undefined) return interaction.update({ content: `<:cancel:1237422533838635028> Nenhum usuário para avisar.`, ephemeral: true, components: [] })
                ...
                interaction.update({ content: `<:accept:1237422643544854549> Avisamos os ${yy.length} que seu produto foi reabastecido com sucesso!`, ephemeral: true, components: [] })
            ...
            if (interaction.customId == 'excluirproduto') {
                ...
                interaction.followUp({ content: `<:accept:1237422643544854549> | Produto excluído com sucesso!`, ephemeral: true })
            }
